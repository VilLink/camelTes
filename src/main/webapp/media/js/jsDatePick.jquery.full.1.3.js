...
/*
	...
	Note: We have implemented a way to change the image path of the Images folder should you decide you want to move it somewhere else.
...
/*
	...
	Since some of the elements inside the CSS have  background:url(Images/Calendario/someimage.png);
	...
	else - you HAVE to look and replace each background:url(Images/Calendario/someimage.png); to the new path you desire.
...
JsDatePick.prototype.setConfiguration = function(aConf){
	...
	this.oConfiguration.imgPath			= (g_jsDatePickImagePath.length != null) ? g_jsDatePickImagePath : "Images/Calendario/";
