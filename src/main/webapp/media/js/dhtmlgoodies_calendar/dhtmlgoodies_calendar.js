...
var pathToImages = '/BtoV/js/images/';	// Relative to your HTML file
...
var selectBoxHighlightColor = '#000000' ; // '#D60808'; // Highlight color of select boxes
var selectBoxRolloverBgColor = '#F0F0F0' ; // '#E2EBED'; // Background color on drop down lists(rollover)
