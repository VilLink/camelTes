...
function Datepicker() {
	...
	this.dpDiv = $('<div id="' + this._mainDivId + '" class="ui-datepicker"></div>');
}
...
$.extend(Datepicker.prototype, {
	...
	_generateHTML: function(inst) {
		...
		var prev = (this._canAdjustMonth(inst, -1, drawYear, drawMonth) ?
			...
			' title="' + prevText + '"><span class="ui-icon-circle-triangle-' + ( isRTL ? 'e' : 'w') + '">' + prevText + '</span></a>' :
		...
		var next = (this._canAdjustMonth(inst, +1, drawYear, drawMonth) ?
			...
			' title="' + nextText + '"><span class="ui-icon-circle-triangle-' + ( isRTL ? 'w' : 'e') + '">' + nextText + '</span></a>' :
