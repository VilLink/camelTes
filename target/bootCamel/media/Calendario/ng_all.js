...
var ng_config_defaults = {
    ...
    button_light_border: false /*[NGALLONLY OPEN]*/ ,
    /*[NGALLONLY Close]*/ // deprecated and will be removed in vs 1.2.5
    /*[NGALLONLY OPEN]*/
...
if (!ng.defined(ng_config.assets_dir)) {
    (function() {
        ...
        for (var b = 0; b < c.length; b++) {
            var d = c[b].getAttribute("src");
            if ((ng.defined(d)) && (d.indexOf(a) != -1)) {
                ng_config.assets_dir = d.replace(a, "assets/");
                break
            }
        }
    })()
...
ng.extend_proto(ng.Events, {
    ...
    add_event: function(b, c) {
        ...
        if ((ng.defined(this.p.events)) && (!ng.defined(this.p.events[b]))) {
            this.p.events[b] = []
        }
        if (ng.defined(this.p.events)) {
            ...
            if (document.addEventListener) {
                ...
                this.attachEvent(b.toLowerCase(), c)
            }
        }
        return this
    },
...
ng.element_methods = {
    ...
    get_plugin: function() {
        var b = this;
        while (b.get("tag") != "body") {
            var a = b.getAttribute("data-ng_plugin");
            if ((ng.defined(a)) && (a != "") && (ng.defined(ng.all_plugins_arr[a]))) {
                return ng.all_plugins_arr[a]
            }
            b = b.get_parent()
        }
        return null
    ...
    get_style: function(b) {
        if (ng.type(b) == "array") {
            return this.get_styles(b)
        }
        b = b.css_camel_case();
        if ((b == "opacity") && (ng.defined(this.p.opacity))) {
            return this.get_opacity() + "%"
        } else {
            if ((b == "zoom") && (ng.defined(this.p.zoom))) {
        ...
        if (k == "") {
            if (this.currentStyle) {
                k = this.currentStyle[b];
                if ((k == "") && (b == "styleFloat")) {
                    k = this.currentStyle["float"]
                }
            } else {
                k = document.defaultView.getComputedStyle(this, null).getPropertyValue(b.css_hyphenate());
                if ((k == "") && (b == "cssFloat")) {
                    k = document.defaultView.getComputedStyle(this, null).getPropertyValue("float")
                }
            }
        }
        if (!ng.defined(k)) {
        ...
        if ((ng.browser.gecko) && ((b == "left") || (b == "top")) && (k == "0px")) {
            var f = this.get_style("position");
            if ((f != "absolute") && (f != "fixed")) {
                k = ""
            }
        }
        if ((k == "") || (k.toLowerCase() == "auto")) {
            if (b == "top") {
                k = this.get_position().top + "px"
            } else {
                if (b == "left") {
                    k = this.get_position().left + "px"
                } else {
                    if (b == "right") {
                        k = (this.get_position().left + this.get_width()) + "px"
                    } else {
                        if (b == "bottom") {
                            k = (this.get_position().top + this.get_height()) + "px"
                        } else {
                            if (b == "width") {
                                k = this.get_width();
                                var g = ["paddingRight", "paddingLeft", "borderRightWidth", "borderLeftWidth"];
                                for (var e = 0; e < g.length; e++) {
                                    var l = this.get_style(g[e]).to_int();
                                    if (!isNaN(l)) {
                                        k -= l
                                    }
                                }
                                ...
                                if (b == "height") {
                                    k = this.get_height();
                                    var g = ["paddingTop", "paddingBottom", "borderTopWidth", "borderBottomWidth"];
                                    for (var e = 0; e < g.length; e++) {
                                        var l = this.get_style(g[e]).to_int();
                                        if (!isNaN(l)) {
                                            k -= l
        ...
        if (k == "") {
            ...
            if ((ng.browser.webkit) || (ng.browser.gecko)) {
                h.border = ["borderTopStyle", "borderTopWidth", "borderTopColor"]
            }
            if (ng.defined(h[b])) {
                for (var e = 0; e < h[b].length; e++) {
                    var l = this.get_style(h[b][e]);
                    if (l != "") {
                        k += l + " "
                    }
                }
        ...
        if (ng.type(k) == "string") {
            var j = k.indexOf("rgb(");
            if (j != -1) {
                var a = k.substr(0, j + 4);
                var d = k.replace(a, "");
                d = d.substr(d.indexOf(")"));
                var c = new ng.Color(k.replace(a, "").replace(d, "").split(","));
                k = a.replace("rgb(", "") + c.get_hex().toLowerCase() + d.replace(")", "")
            }
        }
        if (b == "zoom") {
            if (k.toString().indexOf("%") == -1) {
                k = Math.round(k.to_float() * 100)
            } else {
                k = Math.round(k.to_float())
            }
            this.p.zoom = k;
            k += "%"
        }
    ...
    transform: function() {
        ...
        if ((ng.browser.ie) && (ng.browser.get_ie_version() < 9)) {
            ...
            if ((ng.defined(this.p.transform.translatex)) && (this.p.transform.translatex != 0)) {
                f += this.p.transform.translatex
            }
            if ((ng.defined(this.p.transform.translatey)) && (this.p.transform.translatey != 0)) {
                a += this.p.transform.translatey
            }
            this.style.marginTop = (a + this.p.transform.omt) + "px";
            this.style.marginLeft = (f + this.p.transform.oml) + "px"
        } else {
            if (!ng.defined(this.p.transform.translatex)) {
                this.p.transform.translatex = 0
            }
            if (!ng.defined(this.p.transform.translatey)) {
                this.p.transform.translatey = 0
            }
            if ("MozTransform" in this.style) {
                if (ng.defined(this.p.transform.origin)) {
                    this.style.MozTransformOrigin = this.p.transform.origin
                }
                this.style.MozTransform = "matrix(" + l[0][0] + ", " + l[0][1] + ", " + l[0][2] + ", " + l[0][3] + ", " + this.p.transform.translatex + "px, " + this.p.transform.translatey + "px)"
            } else {
                if ("WebkitTransform" in this.style) {
                    if (ng.defined(this.p.transform.origin)) {
                        this.style.WebkitTransformOrigin = this.p.transform.origin
                    }
                    this.style.WebkitTransform = "matrix(" + l[0][0] + ", " + l[0][1] + ", " + l[0][2] + ", " + l[0][3] + ", " + this.p.transform.translatex + ", " + this.p.transform.translatey + ")"
                } else {
                    if ("OTransform" in this.style) {
                        if (ng.defined(this.p.transform.origin)) {
                            this.style.OTransformOrigin = this.p.transform.origin
                        }
                        this.style.OTransform = "matrix(" + l[0][0] + ", " + l[0][1] + ", " + l[0][2] + ", " + l[0][3] + ", " + this.p.transform.translatex + ", " + this.p.transform.translatey + ")"
                    } else {
                        if ("msTransform" in this.style) {
                            if (ng.defined(this.p.transform.origin)) {
                                this.style.msTransformOrigin = this.p.transform.origin
                            }
                            this.style.msTransform = "matrix(" + l[0][0] + ", " + l[0][1] + ", " + l[0][2] + ", " + l[0][3] + ", " + this.p.transform.translatex + ", " + this.p.transform.translatey + ")"
                        }
                    }
                }
            } if (ng.defined(this.p.transform.origin)) {
            ...
            this.style.transform = "matrix(" + l[0][0] + ", " + l[0][1] + ", " + l[0][2] + ", " + l[0][3] + ", " + this.p.transform.translatex + ", " + this.p.transform.translatey + ")"
        }
        return this
    },
    ...
    remove_class: function(a) {
        ...
        this.className = b.split(" ").remove_value(a).join(" ");
        return this
    },
    ...
    drag: function(d) {
        ...
        if (e(d.cache_targets)) {
            this.p.drag.cache_targets = d.cache_targets
        }
        var a = "mousedown";
        var c = "mouseup";
        var b = "mousemove";
        if ("onpointerdown" in this) {
            ...
            this.p.drag.handle.add_event(a, function(f) {
                ...
                if (ng.defined(f.pointerId)) {
                    ng["drag_mouse_up_" + f.pointerId] = function(g) {
                        if (!ng.defined(g.pointerId)) {
                            g.pointerId = f.pointerId
                        }
                        ng.drag_mouseup(g)
                    };
                    ng["drag_mouse_move_" + f.pointerId] = function(g) {
                        if (!ng.defined(g.pointerId)) {
                            g.pointerId = f.pointerId
                        }
                        ng.drag_mousemove(g)
                    };
                    ng.doc.add_event(c, ng["drag_mouse_up_" + f.pointerId]);
                    ng.doc.add_event(b, ng["drag_mouse_move_" + f.pointerId]);
                    if (("ontouchstart" in this) && (a != "touchstart") && (a.indexOf("pointer") == -1)) {
                        this.add_event("touchend", ng["drag_mouse_up_" + f.pointerId]);
                        ng.doc.add_event("touchmove", ng["drag_mouse_move_" + f.pointerId])
                    } else {
                        if (c == "touchend") {
                            this.add_event("touchend", ng["drag_mouse_up_" + f.pointerId])
                        }
                ...
                ng.last_drag_timer = (function(h) {
                    ...
                    this.fire_event("predragstart", null, h);
                    if (!this.can_drag()) {
                        return this
                    }
                    var l;
                    if (ng.type(this.p.drag.style) != "string") {
                        ...
                        var g = this.p.drag.style;
                        l = g.get_position();
                        if (ng.defined(g.offsetParent)) {
                            var k = ng.get(g.offsetParent).get_position();
                            l.left -= k.left;
                            l.top -= k.top
                        }
                        j[this.p.drag.left] = this.get_style(this.p.drag.left);
                        j[this.p.drag.top] = this.get_style(this.p.drag.top);
                        this.p.drag.style.set_styles(j)
                    } else {
                    ...
                    this.fire_event("dragstart", null, h);
                    var i = 0;
...
ng.set_doc_for_drag = function() {
    ...
    ng.ini_drag = function(m) {
        if (ng.defined(m.pointerId)) {
            var j = ng.drag_object[m.pointerId]
        } else {
            var j = ng.drag_object[0]
        } if (ng.defined(j.object.p.drag_clone_id)) {
            ng.get(j.object.p.drag_clone_id).parentNode.removeChild(ng.get(j.object.p.drag_clone_id))
        }
        if ((j.style == "proxy") || (j.style == "clone")) {
            j.clone_object = j.object.clone_element((j.style == "clone"));
            j.object.p.drag_clone_id = j.clone_object.id;
            j.clone_object.set_style("position", "absolute");
            j.clone_object.setAttribute("data-ng_drag_clone", "1");
            var l = j.object.get_style("width");
            if (isNaN(l.to_int())) {
                l = j.object.get_width()
            }
            var f = j.object.get_style("height");
            if (isNaN(f.to_int())) {
                f = j.object.get_height()
            }
            j.clone_object.set_styles({
                width: l,
                height: f,
                margin: 0
            });
            j.drag_element = j.clone_object;
            j.object.append_element(j.clone_object, "before")
        } else {
            if (j.style == "self") {
                j.drag_element = j.object
            } else {
                j.drag_element = j.style
            }
        } if (!ng.defined(j.pre_pos)) {
            j.pre_pos = j.drag_element.get_position()
        }
        if (ng.defined(j.opacity)) {
            j.pre_opacity = j.drag_element.get_opacity();
            j.drag_element.set_opacity(j.opacity)
        }
        if (ng.defined(j.zoom)) {
            j.pre_zoom = j.drag_element.get_zoom();
            j.drag_element.set_transform("scale", (j.zoom / 100) + "," + (j.zoom / 100)).transform()
        }
        if (j.on_top) {
            j.pre_zIndex = j.drag_element.get_style("zIndex");
            j.drag_element.set_style("zIndex", 100000000)
        }
        if (ng.defined(j.container)) {
            j.ctr_pos = j.container.get_position();
            j.ctr_w = j.container.get_width();
            j.ctr_h = j.container.get_height()
        }
        var d = 0;
        var c = 0;
        if ((ng.defined(j.drag_element.offsetParent)) && (j.drag_element.offsetParent.tagName.toLowerCase() != "body")) {
            var a = ng.get(j.drag_element.offsetParent).get_position();
            c = a.left;
            d = a.top;
            if (ng.defined(j.ctr_pos)) {
                j.ctr_pos.top -= d;
                j.ctr_pos.left -= c
            }
            var b = j.object.get_style("position");
            if ((b != "absolute") && (b != "fixed")) {
                j.object.p.drag.did_offset = null
            }
            if (ng.defined(j.object.p.drag.did_offset)) {
                d = 0;
                c = 0
            }
            j.object.p.drag.did_offset = true
        }
        if ((j.offset.top != 0) || (d != 0)) {
            var k = j.drag_element.get_style(j.top).to_int() + j.offset.top;
            if (ng.browser.gecko) {
                k += d
            }
            j.drag_element.set_style(j.top, k)
        }
        if ((j.offset.left != 0) || (c != 0)) {
            var n = j.drag_element.get_style(j.left).to_int() + j.offset.left;
            if (ng.browser.gecko) {
                n += c
            }
            j.drag_element.set_style(j.left, n)
        }
        j.cache = {};
        j.cache.width = j.drag_element.get_width();
        j.cache.height = j.drag_element.get_height();
        j.cache.top = j.drag_element.get_style(j.top).to_int();
        j.cache.left = j.drag_element.get_style(j.left).to_int();
        j.cache.offset_top = m.top - j.cache.top;
        j.cache.offset_left = m.left - j.cache.left;
        j.cache.prnt_top = d;
        j.cache.prnt_left = c;
        j.targets_pos = [];
        for (var e = 0; e < j.targets.length; e++) {
            j.targets[e] = ng.get(j.targets[e]);
            var g = j.targets[e].get_position();
            j.targets_pos.push({
                element: j.targets[e],
                top: g.top,
                left: g.left,
                width: j.targets[e].get_width(),
                height: j.targets[e].get_height(),
                over: false
            })
        }
        if (j.cache_targets) {
    ...
    ng.fire_drag_events = function(a) {
        ...
        if (ng.defined(a.pointerId)) {
            ...
            for (var b = 0; b < c.targets.length; b++) {
                c.targets[b] = ng.get(c.targets[b]);
                var f = c.targets[b].get_position();
                c.targets_pos[b].top = f.top;
                c.targets_pos[b].left = f.left;
                c.targets_pos[b].width = c.targets[b].get_width();
                c.targets_pos[b].height = c.targets[b].get_height()
            }
        }
    ...
    ng.last_drag_timer = 0;
    ng.drag_mouseup = function(b) {
        clearTimeout(ng.last_drag_timer);
        var h = null;
    ...
    ng.drag_mousemove = function(a) {
        if (ng.defined(a.pointerId)) {
            var d = ng.drag_object[a.pointerId]
        } else {
        ...
        if (d.object.can_drag()) {
            ...
            var g = {
                top: a.top - d.cache.prnt_top,
                left: a.left - d.cache.prnt_left
            };
            var f = {};
            var c = false;
            if (Math.abs(d.drag_pre_point.top - g.top) >= d.grid) {
                var e = d.cache.top - (d.drag_pre_point.top - g.top);
                if (ng.defined(d.ctr_pos)) {
            ...
            if (Math.abs(d.drag_pre_point.left - g.left) >= d.grid) {
                var b = d.cache.left - (d.drag_pre_point.left - g.left);
                if (ng.defined(d.ctr_pos)) {
                    if ((d.ctr_pos.left <= b) && (d.ctr_w + d.ctr_pos.left >= b + d.cache.width)) {
                        d.drag_element.set_style(d.left, b);
                        c = true
                    }
                } else {
                    d.drag_element.set_style(d.left, b);
            ...
            if (c) {
                d.object.fire_event("drag", null, a);
                ng.fire_drag_events(a);
                d.drag_pre_point = g
            }
        }
        if (ng.defined(a.pointerId)) {
            ng.drag_object[a.pointerId] = d
        } else {
            ng.drag_object[0] = d
        }
    };
        ...
        var rdy_func = function() {
            ...
            if (this.p.xhr.readyState == 4) {
                ...
                if ((this.p.xhr.status == success) || (this.p.xhr.status == o_success)) {
                    ...
                    var args = [this.p.xhr.status, this.p.xhr.statusText];
...
ng.extend_proto(ng.PlugIn, {
    ...
    set_object: function(a) {
        if (ng.defined(this.p.object)) {
            ng.get(this.p.object).setAttribute("data-ng_plugin", "");
            ng.get(this.p.object).setAttribute("data-ng_skip", "")
        }
        if (ng.defined(a)) {
            this.p.object = ng.get(a);
            this.p.object.setAttribute("data-ng_plugin", this.id);
            this.p.object.setAttribute("data-ng_skip", "1")
        }
        return this
    },
    get_object: function() {
    ...
    make_id: function(a) {
        ...
        ng.all_plugins_arr[this.id] = this;
        return this
    },
    get_id: function() {
        if (!ng.defined(this.id)) {
    ...
    q_garbage: function() {
        (function() {
            ...
            var a;
            if ((ng.defined(this.get_input)) && (ng.defined(this.get_input()))) {
                a = this.get_input()
            } else {
                if (ng.defined(this.get_object())) {
                    a = this.get_object()
                }
            } if ((ng.defined(a)) && (!document.body.contains(a))) {
                this.remove()
            }
        }.delay(100, this));
        return this
    ...
    remove: function() {
        ...
        this.fire_event("beforeremove");
        var b, a;
        if (this.is_ng_component) {
            a = this.get_parents_components()
        }
        ng.obj_each(this.p, function(d, c) {
            if (ng.defined(d)) {
                if (ng.defined(d.remove_element)) {
                    d.remove_element()
                } else {
                    if ((ng.defined(d.remove)) && (ng.type(d.remove) == "function")) {
                        var e = true;
                        if (ng.type(this) == "button") {
                            if (this.get_component()) {
                                b = this.get_component().id
                            }
                            if (d.id == b) {
                                e = false
                            }
                        } else {
                            if ((this.is_ng_component) && (a.has(d.id))) {
                                e = false
                            }
                        } if (e) {
                            d.remove()
        ...
        this.p = null;
        ng.all_component_arr[this.id] = ng.all_plugins_arr[this.id] = null;
        delete ng.all_component_arr[this.id];
        delete ng.all_plugins_arr[this.id]
    },
    set: function(b, a) {
        if (ng.defined(this["set_" + b])) {
            return this["set_" + b](a)
        }
        this.p[b] = a;
        return this
    },
    get: function(a) {
        if (!ng.defined(this.p[a])) {
            return null
        }
        if (ng.defined(this["get_" + a])) {
            return this["get_" + a]()
        }
        return this.p[a]
    }
...
ng.extend_proto(ng.Component, {
    ...
    set: function() {
        ...
        if ((ng.browser.ie) && (ng.browser.get_ie_version() < 9)) {
            ...
            c.set_html('<div class="ng-comp-input-holder ' + ng.Language.get_dir(this.p.language) + '" id="' + this.id + '_input_div"><div class="ng-comp-close-button" onclick="ng.close_all_component();">&times;</div></div><div class="ng-comp-main-div ' + ng.Language.get_dir(this.p.language) + '" id="' + this.id + '_content"></div>')
        }
    ...
    get_position_style: function(p) {
        if (!ng.defined(p)) {
            var p = this.get_input()
        } else {
            var p = ng.get(p)
        } if (!ng.defined(p)) {
            return {
        ...
        var o = true;
        if ((ng.browser.ie) && (ng.browser.get_ie_version() <= 8)) {
            o = false
        }
        if ((window.innerWidth <= 480) && (o)) {
            var x = ng.doc.clientHeight;
            var m = ng.doc.clientWidth;
            var A = (m - this.get_content_div().get_width()) / 2;
            var v = (x - this.get_content_div().get_height()) / 2;
            if (ng.defined(this.p.responsive_top)) {
                v = this.p.responsive_top
            }
            if (ng.defined(this.p.responsive_left)) {
                A = this.p.responsive_left
            }
            if (v < 15) {
                v = 15
            }
        ...
        var i = p.get_position();
        var g = 1;
        if (ng.Language.get_dir(this.get_language()) == "rtl") {
            g = -1
        }
        var t = this.get_offset();
        var e = t.y;
        var f = t.x;
        var q = i.top + e;
        var u = i.left + (f * g);
        var n = this.get_object().offsetParent;
        if ((ng.defined(n)) && (n.tagName.toLowerCase() != "body")) {
            var c = ng.get(n).get_position();
            f -= c.left;
            e -= c.top
        }
        var r = i.top + e;
        var d = i.left + (f * g);
        var s = this.p.placement;
        var k = this.p.content;
        var l = Math.max(k.get_height(), k.scrollHeight);
        var b = Math.max(k.get_width(), k.scrollWidth);
        if (window.innerWidth) {
            var a = window.innerHeight;
            var z = window.innerWidth
        } else {
            var a = ng.doc.get_height();
            var z = ng.doc.get_width()
        }
        var y = Math.max(ng.doc.get_scroll_top(), document.body.scrollTop);
        var B = Math.max(ng.doc.get_scroll_left(), document.body.scrollLeft);
        if (s.charAt(0) == "a") {
            if (((q + l - y) > a) && (l <= q - y)) {
                s = "t" + s.substr(1, 1) + "b" + s.substr(3, 1)
            } else {
                s = "b" + s.substr(1, 1) + "t" + s.substr(3, 1)
            }
        }
        if (s.charAt(1) == "a") {
            if (g == -1) {
                if (((u + b - (z - B)) > z) && (b <= u - (z - B))) {
                    s = s.substr(0, 1) + "l" + s.substr(2, 1) + "l"
                } else {
                    s = s.substr(0, 1) + "r" + s.substr(2, 1) + "r"
                }
            } else {
                if (((u + b - B) > z) && (b <= u - B)) {
                    s = s.substr(0, 1) + "r" + s.substr(2, 1) + "r"
    ...
    set_object: function(a) {
        ...
        if ((ng.defined(this.p.object)) && (this.p.object.remove_event)) {
            ...
            this.p.object.setAttribute("data-ng_plugin", "");
            ng.get(this.p.object).setAttribute("data-ng_skip", "")
        }
        if (ng.defined(a)) {
            this.p.object = ng.get(a);
    ...
    set_input: function(a) {
        ...
        if ((ng.defined(this.p.input)) && (this.p.input.remove_events)) {
            ...
            this.p.input.setAttribute("data-ng_plugin", "")
        }
        ...
        this.p.input.setAttribute("data-ng_plugin", this.id);
        ...
        if (ng.UI) {
            ...
            (function() {
                if ((ng.defined(this.p.button)) && (ng.defined(this.p.input))) {
                    var f = this.p.button.get_object();
                    var c = this.p.input;
                    if (ng.defined(c)) {
                        var g = c.get_height();
                        var e = f.get_height();
                        if (e > g) {
                            var i = f.get_style("borderTopWidth").to_int();
                            if (isNaN(i)) {
                                i = 0
                            }
                            var d = f.get_style("borderBottomWidth").to_int();
                            if (isNaN(d)) {
                                d = 0
                            }
                            f.set_style("height", g - i - d)
                        } else {
                            if (e < g) {
                                g = g - e;
                                f.set_styles({
                                    paddingTop: Math.floor(g / 2),
                                    paddingBottom: Math.ceil(g / 2)
                                })
                            }
                        }
                    }
...
ng.garbage_collect = (function() {
    ng.obj_each(ng.all_plugins_arr, function(b, a) {
        if (!ng.defined(b)) {
            return
        }
        var c;
        if ((ng.defined(b.get_input)) && (ng.defined(b.get_input()))) {
            c = b.get_input()
        } else {
            if (ng.defined(b.get_object())) {
                c = b.get_object()
            }
        } if ((ng.defined(c)) && (!document.body.contains(c))) {
            b.q_garbage()
        }
    })
}).repeat(30000);
...
ng.extend_proto(ng.Button, {
    ...
    render: function(g) {
        ...
        var c = g.get("tag");
        if ((g.disabled) || (g.getAttribute("disabled") == "disabled")) {
            (function() {
                this.disable()
            }.defer(this))
        }
        ...
        if ((c == "input") || (c == "button")) {
            ...
            if (g.get("type").toLowerCase() == "submit") {
                a = '<div style="position:absolute; width:0px; height:0px; overflow:hidden;"><input ' + l + ' type="submit" name="' + g.name + '" value="' + this.get_value() + '" ' + this.p.xobjEvents.get_html() + " /></div>"
            }
        } else {
            if (this.get_text() == "") {
                this.set_text(g.get_html())
        ...
        if (a == "") {
            if (c == "a") {
                if ((!ng.defined(this.p.link)) || (this.p.link == "")) {
                    this.p.link = "#"
                }
                k = "<a " + l + ' href="' + this.p.link + '" ' + this.p.xobjEvents.get_html() + ">";
                a = "</a>"
            } else {
                a = '<div style="position:absolute; width:0px; height:0px; overflow:hidden;"><a ' + l + ' href="#" name="' + g.get("name") + '" value="' + this.get_value() + '" ' + this.p.xobjEvents.get_html() + "></a></div>"
            }
        }
        var h = [];
        ...
        h.push(ng.Language.get_dir(this.get_language()) + '" title="' + g.get("title") + '" data-ng_skip="1" onselectstart="return false">' + k);
        if (!ng.defined(ng.UI)) {
            ...
            if (ng.defined(this.get_icon())) {
                ...
                if (this.p.hide_icon) {
                    ...
                    var d = j.split(",");
                    h.push('<span class="' + d[0].trim() + ' ng-button-icon-span"' + m + ' id="' + this.id + '_icon">');
                    ...
                    h.push("<img src='" + j + "' border='0' id='" + this.id + "_icon' class='ng-button-icon-img'" + m + " />")
                }
            }
            ...
            h.push("<span id='" + this.id + "_text'" + m + " class='ng-button-text-span'>" + this.get_text() + "</span>");
            ...
            if (ng.defined(this.get_component())) {
                ...
                h.push("<img id='" + this.id + "_component' class='ng-button-arrow-img'" + m + " />")
            }
            h.push("</td></tr></table>");
            h.push("</div></div>")
        } else {
            ...
            h.push('<b id="' + this.id + '_count"' + m + ' class="ng-button-count">' + this.p.count + "</b>");
            ...
            if (j.indexOf(".") == -1) {
                ...
                h.push('<span id="' + this.id + '_icon" class="ng-button-icon-span"' + m + ">");
                if (j == "") {
                    h.push("&nbsp;")
                } else {
            ...
            h.push('<span id="' + this.id + '_text"' + m + ' class="ng-button-text-span">' + e + "</span>");
            m = ' style="display:none;" ';
            if ((ng.defined(this.get_component())) && (!this.p.hide_component)) {
                m = ""
            }
            h.push('<span id="' + this.id + '_component"' + m + ' class="ng-button-arrow"></span>')
        }
        h.push(a);
        h.push("</span>");
        ng.hold_html(h.join(""));
        ...
        var n = this.get_color();
        if (this.is_checked()) {
            if (ng.defined(ng.UI)) {
                ng.get(this.id).add_class("checked")
            }
            n = this.get_checked_color()
        }
        if (this.is_disabled()) {
            if (ng.defined(ng.UI)) {
                ng.get(this.id).add_class("disabled")
            }
            n = this.get_disable_color()
        }
        if (!ng.defined(ng.UI)) {
            this.apply_colors(n);
...
(function() {
    ...
    ng.Assets.load_style(ng_config.assets_dir + "css/" + ng_config.css_skin_prefix + "ui.css");
    if (ng_config.load_icons) {
        ng.Assets.load_style(ng_config.assets_dir + "css/" + ng_config.css_skin_prefix + "icons.css")
    }
    ng.UI = {
        ini_funcs: {},
        add_to_ini: function(b, c) {
            ng.UI.ini_funcs[b] = c
        },
        common_ini: function(c, b) {
            var c = ng.get(c);
            if (c.getAttribute("data-ng_skip") == "1") {
                return
            }
            c.setAttribute("data-ng_skip", "1");
            new b(c)
        },
        ini: function() {
            ng.obj_each(ng.UI.ini_funcs, function(c, b) {
                ng.UI.create(b, c, document.body)
            })
        },
        create: function(b, f, d) {
            var e = ng.get(d).get_children_by_class_name(b, "");
            for (var c = 0; c < e.length; c++) {
                if (e[c].getAttribute("data-ng_skip") != "1") {
                    f(e[c])
                }
            }
        },
        match_buttons_height: function(c) {
            var b = 0;
            ng.get(c).get_children_by_class_name("ng-button", "*", function(d) {
                b = Math.max(b, d.get_style("height").to_int())
            });
            if (b == 0) {
                return
            }
            ng.get(c).get_children_by_class_name("ng-button", "*", function(d) {
                d.set_style("height", b)
            })
        }
    };
    var a = function(e) {
        if (e.getAttribute("data-ng_skip") == "1") {
            return
        }
        if (e.get("tag") == "label") {
            ...
            if (d.length) {
                d = ng.get(d[0]);
                e.append_element(d, "after");
                d.set_style("display", "none");
                var b = d.type.toLowerCase();
                var c = ng.create("button", {
                    className: d.className + " " + b,
                    html: e.innerHTML,
                    type: "button"
                });
                if (ng.defined(e.dataset)) {
                    ng.obj_each(e.dataset, function(h, g) {
                        c.dataset[g] = e.dataset[g]
                    })
                }
                c.setAttribute("data-stop_default", "1");
                if (d.checked) {
                ...
                e.append_element(c, "before");
                e.remove_element();
                var e = f(c);
                e.p.input_field = d;
                if (b == "radio") {
                    if (!ng.defined(ng.radio_buttons)) {
                        ng.radio_buttons = {}
                    }
                    if (d.checked) {
                        ng.radio_buttons[d.name] = e
                    }
                    e.add_event("click", function() {
                        if (ng.defined(ng.radio_buttons[this.p.input_field.name])) {
                            ng.radio_buttons[this.p.input_field.name].uncheck()
                        }
                        this.p.input_field.checked = true;
                        ng.radio_buttons[this.p.input_field.name] = this;
                        this.check()
                    })
                } else {
                    if (d.type.toLowerCase() == "checkbox") {
                        e.add_event("click", function() {
                            this.p.input_field.checked = !this.p.input_field.checked;
                            if (this.p.input_field.checked) {
                                this.check()
                            } else {
                                this.uncheck()
                            }
        ...
        function f(l) {
            var m = l.get("data-split");
            if ((ng.defined(m)) && (m != "")) {
                var n = ng.create("span", {
                    className: "ng-split-button"
                });
                l.append_element(n, "before");
                n.append_element(l);
                var j = ng.create(l.get("tag"), {
                    className: l.className
                });
                j.setAttribute("data-options", m);
                n.append_element(j);
                f(j)
            }
            var g = l.get("data-options");
            var k;
            if ((ng.defined(g)) && (g != "")) {
                k = new ng.Component({
                    responsive_left: 0
                });
                var h = k.get_content_div();
                g = ng.get(g);
                h.remove_class("ng-comp-main-div").append_element(g);
                g.add_class("ng-floating").remove_class("ng-sub-buttons");
                g.add_event("mouseup", function(p) {
                    k.close()
                });
                l.setAttribute("data-stop_default", 1)
            }
            var o = l.className.replace("ng-button", "").trim();
            if (o != "") {
                l.setAttribute("data-ui_class", o)
            }
            var i = new ng.Button(l);
            if (ng.defined(k)) {
                i.set_component(k).show_component()
            }
            return i
        }
    };
    ng.UI.add_to_ini("ng-button", a);
    ng.UI.add_to_ini("ng-buttons-horizontal", ng.UI.match_buttons_height);
    ng.ready(function() {
        ng.UI.ini.defer()
    })
})();
ng.ProgressBar = function(a) {
    this.p = this.create_options(a, {
        css_prefix: "ng_progress_",
        style: "bar",
        bg_color: null,
        text_color: null,
        language: ng_config.language,
        value: null,
        hide: false,
        overlap: null,
        overlap_style: null,
        complete_text: null,
        complete_class: "",
        indeterminate_text: null,
        hide_text: false
    });
    this.create_events();
    this.make_id("progress");
    if ((ng.browser.ie) && (ng.browser.get_ie_version() < 9)) {
        this.p.style = "bar"
    }
    if (!ng.defined(this.p.complete_text)) {
        this.set_complete_text(ng.Language.t("complete", this.p.language))
    }
    if (!ng.defined(this.p.indeterminate_text)) {
        this.set_indeterminate_text(ng.Language.t("loading", this.p.language))
    }
    this.p.indeterminate_timer = 0;
    this.p.indeterminate_left = 0;
    if (ng.defined(this.p.object)) {
        this.render(this.p.object)
    }
};
(function() {
    if (!ng_config.use_ui) {
